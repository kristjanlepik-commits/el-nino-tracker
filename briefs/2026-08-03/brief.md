# El Niño Probability Tracker, week of 2026-08-03
...
- BoM ENSO Outlook, issued 2026-07-28: El Niño firmly established as tropical Pacific continues to warm. Categorical only.
...
| Indicator | Current (week of 2026-07-29) | 1997 same week | 2015 same week |
|---|---|---|---|
| Niño 3.4 weekly (traditional) | +2.3°C | +1.4°C | +1.3°C |
| Niño 3.4 weekly (RONI) | +1.5°C | n/a (pre-RONI) | n/a (pre-RONI) |
| 0-300m heat content anomaly | +2.94°C (CPC monthly, 180W-100W, vs 1981-2010 climo) | +1.83°C | +1.69°C |
| Cumulative westerly wind anomaly since Mar 1 | (CWWA fetch failed; not computed this run) | n/a | n/a |

**Heat content note:** At +2.94°C, 2026 exceeds both 1997 (+1.83°C) and 2015 (+1.69°C) at the same calendar month, running ahead of either super-event analog at this stage of development.
...
**WWB events (spatial-peak detection, v1.7):** 11 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (15), 2015 (15), 2023 (12), 2025 (6).
  ...
  - 2026-07-13 to 2026-07-23, 11 days, peak 17.36 m/s, peak day 2026-07-17
  - 2026-07-24 to 2026-07-29, 6 days, peak 18.38 m/s, peak day 2026-07-29
...
On count: 2026 has 11 events so far; analogs at the same calendar date: 1997 (15), 2015 (15), 2023 (12), 2025 (6). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
- **bom**: prior issued 2026-07-14, now issued 2026-07-28.

**Unchanged since last issue:** cpc_strength, iri, ecmwf.

**Physical state deltas:**

- nino34_weekly_traditional: 2.2 -> 2.3 (delta +0.1)
- nino34_weekly_roni: 1.4 -> 1.5 (delta +0.1)
- heat_content_0_300m_estimate: 2.26 -> 2.94 (delta +0.68)
- wwb_events_since_mar1: 10 -> 11 (delta +1)
...
- **oisst_weekly**: fetched live, issued 2026-07-29.
- **heat_content**: fetched live, issued 2026-07-31.
- **iri**: fetched live, issued 2026-07-20.
- **bom**: fetched live, issued 2026-07-28.
- **ecmwf_seas5**: fetched live, issued 2026-07-01.
- **era5_wwe**: not implemented or cache empty; using seed values from sources.py.
- **era5_burst**: fetched live, issued 2026-07-29.
- **oni_history**: fetched live, issued 2026-06-30.
- **nmme**: fetched live, issued 2026-07-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.9. RONI offset +0.80°C (live, week of 2026-07-29). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
