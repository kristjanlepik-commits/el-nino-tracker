# El Niño Probability Tracker, week of 2026-07-06
...
Headline numbers below are CPC-derived after translating from RONI bins to traditional ONI thresholds, then fitting a skew-normal distribution to the nine bin probabilities and evaluating its survival function at each threshold. RONI-to-traditional-ONI offset is +0.60°C, the live tropical-mean SST anomaly observed for the week of 2026-07-01 (CPC). ECMWF SEAS5 member counts in caveat 2 are a second quantitative cross-check.

- **At least moderate (>+1.0°C peak)**: 100%
- **Strong (>+1.5°C peak)**: 100% (CPC anchor 99%, 6-model consensus 100%, deflection +0.8 ppt)
- **Very strong / super (>+2.0°C peak)**: 95% (CPC anchor 91%, 6-model consensus 96%, deflection +4.1 ppt)
- **1997/2015 magnitude (>+2.5°C peak)**: 80% (CPC anchor 69%, 6-model consensus 82%, deflection +11.5 ppt)
- **Beyond instrumental record (>+3.0°C peak)**: 66% (CPC anchor 37%, 6-model consensus 72%, deflection +29.3 ppt)
- **Far beyond record (>+3.5°C peak)**: 42% (CPC anchor 13%, 6-model consensus 47%, deflection +29.1 ppt)
...
- NOAA CPC strength table, NDJ 2026-27 (RONI): super 63%, strong 25%, moderate 10%, weak El Niño 2%, neutral 0%, La Niña 0%. Issued 2026-06-11.
...
4. The +3.0°C and +3.5°C buckets are the most model-dependent numbers in the headline. +3.0°C exceeds every event in the instrumental record (1997 ~2.4, 2015 ~2.6, 1877 ~2.5 on HadISST), and it sits beyond CPC's published strength bins (which top out at >=2.0 RONI), so its CPC anchor (37%) is a deep skew-normal tail extrapolation. Under the consensus weighting the +3.0 bucket (66%) is driven mostly by direct model member counts, not that extrapolation. The +3.5°C bucket (42%, added 2026-07-06 once the July SEAS5 run pushed the top of the distribution past where +3.0 discriminates) is even more model-driven: its CPC anchor (13%) is effectively zero (that threshold is ~+3.0 RONI, far past CPC's top bin), so it is almost entirely direct model member counts above +3.5. Read it as 'where the hot models cluster,' not a calibrated probability, and note it leans hardest on the July ECMWF run.

## 2. Physical state panel

| Indicator | Current (week of ~22 Apr 2026) | 1997 same week | 2015 same week |
|---|---|---|---|
| Niño 3.4 weekly (traditional) | +1.8°C | -0.1°C | +0.6°C |
| Niño 3.4 weekly (RONI) | +1.2°C | n/a (pre-RONI) | n/a (pre-RONI) |
| 0-300m heat content anomaly | +2.26°C (CPC monthly, 180W-100W, vs 1981-2010 climo) | +0.7°C | +1.6°C |
| Cumulative westerly wind anomaly since Mar 1 | 319 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 589 | 456 |
...
**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-07-01, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (319) tracks closest to 2015 (456); other reference years: 1997 (589), 2023 (99), 2025 (10). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 8 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (9), 2015 (11), 2023 (9), 2025 (4).
  ...
  - 2026-06-05 to 2026-06-22, 18 days, peak 14.82 m/s, peak day 2026-06-13
  - 2026-06-23 to 2026-07-01, 9 days, peak 15.97 m/s, peak day 2026-07-01
...
On count: 2026 has 8 events so far; analogs at the same calendar date: 1997 (9), 2015 (11), 2023 (9), 2025 (4). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
|---|---|---|---|---|---|---|---|---|
| NCEP CFSv2 | 32 | 3.58°C | 100% | 100% | 100% | 100% | 94% | 59% |
| CanESM5 | 20 | 2.07°C | 100% | 100% | 75% | 0% | 0% | 0% |
| GEM5.2-NEMO | 20 | 3.13°C | 100% | 100% | 100% | 95% | 55% | 20% |
| NCAR CCSM4 | 10 | 3.21°C | 100% | 100% | 100% | 100% | 80% | 10% |
| NCAR CESM1 | 10 | 4.95°C | 100% | 100% | 100% | 100% | 100% | 100% |
| **Consensus (equal model wt)** | 5 models | **3.39°C** | 100% | 100% | 95% | 79% | 66% | 38% |
...
- **ecmwf**: prior issued 2026-06-01, now issued 2026-07-01.
- **bom**: prior issued 2026-06-16, now issued 2026-06-30.

**Unchanged since last issue:** cpc_strength, iri.

**Physical state deltas:**

- heat_content_0_300m_estimate: 1.99 -> 2.26 (delta +0.27)
- cwwa_ms_days: 290.24 -> 319.01 (delta +28.77)
...
- **cpc_strength**: fetched live, issued 2026-06-11.
- **oisst_weekly**: fetched live, issued 2026-07-01.
...
- **era5_wwe**: fetched live, issued 2026-07-01.
- **era5_burst**: fetched live, issued 2026-07-01.
- **oni_history**: fetched live, issued 2026-06-30.
- **nmme**: fetched live, issued 2026-06-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.8. RONI offset +0.60°C (live, week of 2026-07-01). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
