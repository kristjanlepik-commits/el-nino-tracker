...
*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.2. RONI offset +0.40°C (live, week of 2026-04-15). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
