...
*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.4. RONI offset +0.50°C (live, week of 2026-04-22). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
