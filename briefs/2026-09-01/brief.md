# El Niño Probability Tracker, week of 2026-09-01
...
| 0-300m heat content anomaly | +3.20°C (CPC monthly, 180W-100W, vs 1981-2010 climo) | +1.79°C | +1.97°C |
| Cumulative westerly wind anomaly since Mar 1 | 653 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 805 | 719 |

**Heat content note:** At +3.20°C, 2026 exceeds both 1997 (+1.79°C) and 2015 (+1.97°C) at the same calendar month, running ahead of either super-event analog at this stage of development.

**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-08-27, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (653) tracks closest to 2015 (719); other reference years: 1997 (805), 2023 (162), 2025 (11). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 13 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (15), 2015 (15), 2023 (12), 2025 (6).
  ...
  - 2026-08-07 to 2026-08-20, 14 days, peak 18.48 m/s, peak day 2026-08-13
  - 2026-08-21 to 2026-08-27, 7 days, peak 17.52 m/s, peak day 2026-08-27
...
On count: 2026 has 13 events so far; analogs at the same calendar date: 1997 (15), 2015 (15), 2023 (12), 2025 (6). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
- **bom**: prior issued 2026-08-11, now issued 2026-09-01.

**Unchanged since last issue:** cpc_strength, iri, ecmwf, nmme.

**Physical state deltas:**

- heat_content_0_300m_estimate: 2.96 -> 3.2 (delta +0.24)
- cwwa_ms_days: 639.45 -> 653.17 (delta +13.72)
...
- **era5_wwe**: fetched live, issued 2026-08-27.
- **era5_burst**: fetched live, issued 2026-08-27.
