# El Niño Probability Tracker, week of 2026-08-24
...
4. The +3.0°C and +3.5°C buckets are the most model-dependent numbers in the headline. +3.0°C exceeds every event in the instrumental record (1997 +2.37, 2015 +2.59), and it sits beyond CPC's published strength bins (which top out at >=2.0 RONI), so its CPC anchor (81%) is a deep skew-normal tail extrapolation. Under the consensus weighting the +3.0 bucket (93%) is driven mostly by direct model member counts, not that extrapolation. The +3.5°C bucket (65%, added 2026-07-06 once the July SEAS5 run pushed the top of the distribution past where +3.0 discriminates) is even more model-driven: its CPC anchor (45%) is effectively zero (that threshold is ~+3.0 RONI, far past CPC's top bin), so it is almost entirely direct model member counts above +3.5. Read it as 'where the hot models cluster,' not a calibrated probability, and note it leans hardest on the July ECMWF run.

## 2. Physical state panel

| Indicator | Current (week of 2026-08-19) | 1997 same week | 2015 same week |
|---|---|---|---|
| Niño 3.4 weekly (traditional) | +2.6°C | +1.8°C | +1.8°C |
...
| Cumulative westerly wind anomaly since Mar 1 | 593 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 753 | 696 |
...
**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-08-18, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (593) tracks closest to 2015 (696); other reference years: 1997 (753), 2023 (155), 2025 (11). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 12 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (14), 2015 (14), 2023 (11), 2025 (5).
  ...
  - 2026-07-25 to 2026-08-06, 13 days, peak 20.85 m/s, peak day 2026-07-31
  - 2026-08-07 to 2026-08-18, 12 days, peak 18.48 m/s, peak day 2026-08-13
...
On count: 2026 has 12 events so far; analogs at the same calendar date: 1997 (14), 2015 (14), 2023 (11), 2025 (5). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
**RONI->trad ONI offset changed: +0.9°C -> +0.8°C.** This shifts headline buckets even without underlying probability changes; flag in editorial.

**New agency releases since last issue:**

- **iri**: prior issued 2026-07-20, now issued 2026-08-19.

**Unchanged since last issue:** cpc_strength, ecmwf, bom, nmme.

**Physical state deltas:**

- nino34_weekly_traditional: 2.7 -> 2.6 (delta -0.1)
- cwwa_ms_days: 545.68 -> 592.69 (delta +47.01)
...
- **oisst_weekly**: fetched live, issued 2026-08-19.
...
- **era5_wwe**: fetched live, issued 2026-08-18.
- **era5_burst**: fetched live, issued 2026-08-19.
- **oni_history**: fetched live, issued 2026-07-31.
- **nmme**: fetched live, issued 2026-08-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.11. RONI offset +0.80°C (live, week of 2026-08-19). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
