# El Niño Probability Tracker, week of 2026-06-29
...
| Cumulative westerly wind anomaly since Mar 1 | 290 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 584 | 415 |
...
**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-06-24, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (290) tracks closest to 2015 (415); other reference years: 1997 (584), 2023 (99), 2025 (10). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 8 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (9), 2015 (10), 2023 (9), 2025 (4).
  ...
  - 2026-06-19 to 2026-06-24, 6 days, peak 15.84 m/s, peak day 2026-06-24
...
On count: 2026 has 8 events so far; analogs at the same calendar date: 1997 (9), 2015 (10), 2023 (9), 2025 (4). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
- nino34_weekly_traditional: 1.7 -> 1.8 (delta +0.1)
- nino34_weekly_roni: 1.1 -> 1.2 (delta +0.1)
- cwwa_ms_days: 269.32 -> 290.24 (delta +20.92)
- wwb_events_since_mar1: 7 -> 8 (delta +1)
...
- **oisst_weekly**: fetched live, issued 2026-06-24.
...
- **era5_wwe**: fetched live, issued 2026-06-24.
- **era5_burst**: fetched live, issued 2026-06-24.
- **oni_history**: fetched live, issued 2026-05-31.
- **nmme**: fetched live, issued 2026-06-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.8. RONI offset +0.60°C (live, week of 2026-06-24). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
