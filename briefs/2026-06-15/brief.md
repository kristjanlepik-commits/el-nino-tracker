# El Niño Probability Tracker, week of 2026-06-15
...
- **Beyond instrumental record (>+3.0°C peak)**: 66% (CPC anchor 37%, 6-model consensus 71%, deflection +28.8 ppt)
...
4. The +3.0°C bucket (66%) is the most model-dependent number in the headline. +3.0°C exceeds every event in the instrumental record (1997 ~2.4, 2015 ~2.6, 1877 ~2.5 on HadISST), and it sits beyond CPC's published strength bins (which top out at >=2.0 RONI), so its CPC anchor (37%) is the deepest skew-normal tail extrapolation in the brief; the model consensus above +3.0 is 71%. Under the v1.8 consensus weighting the bucket is driven mostly by direct model member counts above +3.0, not by that extrapolation, but read it as the brief's least-anchored figure.

## 2. Physical state panel

| Indicator | Current (week of ~22 Apr 2026) | 1997 same week | 2015 same week |
|---|---|---|---|
| Niño 3.4 weekly (traditional) | +1.5°C | -0.1°C | +0.6°C |
| Niño 3.4 weekly (RONI) | +0.9°C | n/a (pre-RONI) | n/a (pre-RONI) |
| 0-300m heat content anomaly | +1.99°C (CPC monthly, 180W-100W, vs 1981-2010 climo) | +0.7°C | +1.6°C |
| Cumulative westerly wind anomaly since Mar 1 | 230 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 501 | 393 |
...
**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-06-09, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (230) tracks closest to 2023 (89); other reference years: 1997 (501), 2015 (393), 2025 (9). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 7 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (8), 2015 (9), 2023 (8), 2025 (4).
  ...
  - 2026-06-03 to 2026-06-09, 7 days, peak 13.34 m/s, peak day 2026-06-09
...
On count: 2026 has 7 events so far; analogs at the same calendar date: 1997 (8), 2015 (9), 2023 (8), 2025 (4). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.
...
- **cpc_strength**: prior issued 2026-05-14, now issued 2026-06-11.
    - NDJ neutral: 2% -> 0% (Delta -2)
    - NDJ 0.5to1.0: 9% -> 2% (Delta -7)
    - NDJ 1.0to1.5: 22% -> 10% (Delta -12)
    - NDJ 1.5to2.0: 30% -> 25% (Delta -5)
    - NDJ >=2.0: 37% -> 63% (Delta +26)
- **ecmwf**: prior issued 2026-04-05, now issued 2026-06-01.
- **bom**: prior issued 2026-05-26, now issued 2026-06-09.

**Unchanged since last issue:** iri.

**Physical state deltas:**

- nino34_weekly_traditional: 1.3 -> 1.5 (delta +0.2)
- nino34_weekly_roni: 0.7 -> 0.9 (delta +0.2)
- heat_content_0_300m_estimate: 1.98 -> 1.99 (delta +0.01)
- cwwa_ms_days: 199.37 -> 229.83 (delta +30.46)
...
- **oisst_weekly**: fetched live, issued 2026-06-10.
...
- **era5_wwe**: fetched live, issued 2026-06-09.
- **era5_burst**: fetched live, issued 2026-06-10.
- **oni_history**: fetched live, issued 2026-05-31.
- **nmme**: fetched live, issued 2026-06-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.8. RONI offset +0.60°C (live, week of 2026-06-10). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
