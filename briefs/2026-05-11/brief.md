# El Niño Probability Tracker, week of 2026-05-11
...
*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.5. RONI offset +0.50°C (live, week of 2026-05-06). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
