# El Niño Probability Tracker, week of 2026-06-08
...
**RONI->trad ONI offset changed: +0.5°C -> +0.6°C.** This shifts headline buckets even without underlying probability changes; flag in editorial.
...
*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.8. RONI offset +0.60°C (live, week of 2026-06-03). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
