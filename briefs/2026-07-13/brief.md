# El Niño Probability Tracker, week of 2026-07-13
...
Headline numbers below are CPC-derived after translating from RONI bins to traditional ONI thresholds, then fitting a skew-normal distribution to the nine bin probabilities and evaluating its survival function at each threshold. RONI-to-traditional-ONI offset is +0.70°C, the live tropical-mean SST anomaly observed for the week of 2026-07-08 (CPC). ECMWF SEAS5 member counts in caveat 2 are a second quantitative cross-check.

- **At least moderate (>+1.0°C peak)**: 100%
- **Strong (>+1.5°C peak)**: 100%
- **Very strong / super (>+2.0°C peak)**: 98%
- **1997/2015 magnitude (>+2.5°C peak)**: 91% (CPC anchor 85%, 6-model consensus 92%, deflection +6.4 ppt)
- **Beyond instrumental record (>+3.0°C peak)**: 79% (CPC anchor 54%, 6-model consensus 83%, deflection +24.9 ppt)
- **Far beyond record (>+3.5°C peak)**: 54% (CPC anchor 21%, 6-model consensus 60%, deflection +33.0 ppt)
...
- NOAA CPC strength table, NDJ 2026-27 (RONI): super 75%, strong 20%, moderate 5%, weak El Niño 0%, neutral 0%, La Niña 0%. Issued 2026-07-09.
- IRI plume, DJF 2026-27: El Niño 98%, neutral 2%, La Niña 0%. Issued 2026-05-19. Strength not broken out in the public Quick Look.
- BoM ENSO Outlook, issued 2026-06-30: El Niño in the tropical Pacific. Categorical only.
- ECMWF SEAS5, run 2026-07-01: 51-member SEAS5 ensemble for 2027-01: median Niño 3.4 anomaly +3.93 deg C; 51/51 members above +1.5 (~100% above +2.0, ~100% above +2.5).

**Caveats this issue:**

1. The +2.5°C bucket carries a 82-87% range. It comes from a bootstrap that perturbs CPC's published bin probabilities by Gaussian noise (sigma 1 percentage point, matching CPC's whole-percent reporting precision) and refits the skew-normal each time. The range therefore reflects reporting-quantization uncertainty in CPC's table, not underlying forecast uncertainty.
2. ECMWF SEAS5 vs CPC, upper tail above +2.5°C trad ONI: SEAS5 has 51/51 members (100%) at 2027-01 (max available lead). CPC's NDJ 2026-27 bucket lands at 82-87%. We subtract SEAS5's own model climatology, which removes its known ENSO warm bias; an observational-climatology subtraction would put SEAS5 higher still. Real disagreement to surface, not a number to average.
...
4. The +3.0°C and +3.5°C buckets are the most model-dependent numbers in the headline. +3.0°C exceeds every event in the instrumental record (1997 ~2.4, 2015 ~2.6, 1877 ~2.5 on HadISST), and it sits beyond CPC's published strength bins (which top out at >=2.0 RONI), so its CPC anchor (54%) is a deep skew-normal tail extrapolation. Under the consensus weighting the +3.0 bucket (79%) is driven mostly by direct model member counts, not that extrapolation. The +3.5°C bucket (54%, added 2026-07-06 once the July SEAS5 run pushed the top of the distribution past where +3.0 discriminates) is even more model-driven: its CPC anchor (21%) is effectively zero (that threshold is ~+3.0 RONI, far past CPC's top bin), so it is almost entirely direct model member counts above +3.5. Read it as 'where the hot models cluster,' not a calibrated probability, and note it leans hardest on the July ECMWF run.

## 2. Physical state panel

| Indicator | Current (week of ~22 Apr 2026) | 1997 same week | 2015 same week |
|---|---|---|---|
| Niño 3.4 weekly (traditional) | +2.0°C | -0.1°C | +0.6°C |
| Niño 3.4 weekly (RONI) | +1.3°C | n/a (pre-RONI) | n/a (pre-RONI) |
| 0-300m heat content anomaly | +2.26°C (CPC monthly, 180W-100W, vs 1981-2010 climo) | +0.7°C | +1.6°C |
| Cumulative westerly wind anomaly since Mar 1 | 360 m/s·days (CWWA, ERA5 130E-150W, vs 1991-2020 climo) | 591 | 509 |
...
**CWWA note:** Live ERA5 daily 850 hPa zonal wind through 2026-07-07, area-meaned over 5N-5S, 130E-150W and integrated for positive (westerly) anomalies vs the 1991-2020 same-calendar-day climatology. At the same calendar date, 2026 CWWA (360) tracks closest to 2015 (509); other reference years: 1997 (591), 2023 (99), 2025 (10). Caveat: CWWA is a cumulative-area-mean metric and systematically understates transient localized westerly wind bursts, including those occurring just outside the 5N-5S band. A short intense burst can generate a downwelling Kelvin wave that does substantial physical work even when it barely moves the cumulative integral. For the operational read on whether ENSO development is on track, the surfacing-Kelvin-wave evidence in heat content (above) is at least as informative as this metric. See the WWB row below for the spatial-peak event count and analyst read (v1.7, complementary to CWWA).

**WWB events (spatial-peak detection, v1.7):** 9 westerly wind burst events detected since Mar 1, 2026. Detection: sliding 5x10 deg sub-region area-mean anomaly over 10N-10S, 130E-150W; dual threshold (5 m/s sustained for at least 5 days, peak day above 7 m/s) with peak-detection plus a 10-day recovery interval between events. Analogs (events to same calendar date): 1997 (10), 2015 (11), 2023 (9), 2025 (4).
  ...
  - 2026-07-01 to 2026-07-07, 7 days, peak 18.69 m/s, peak day 2026-07-07
...
On count: 2026 has 9 events so far; analogs at the same calendar date: 1997 (10), 2015 (11), 2023 (9), 2025 (4). v1.7's peak-detection algorithm with a 10-day recovery interval splits sustained westerly periods into distinct bursts where v1.6 collapsed them. The count is now reasonably comparable across years, but peak amplitude remains the cleaner single number.

## 2b. Multi-model consensus (NMME)

North American Multi-Model Ensemble, init 2026070800 (issued 2026-07-08). Peak Nino 3.4 over Nov 2026 - Feb 2027 (NDJ-DJF), region 5N-5S, 170W-120W. Each cell is the percent of that model's ensemble members whose peak exceeds the threshold. Anomalies are vs each model's own hindcast climatology (same convention as SEAS5).

| Model | Members | Peak (mean) | >+1.0 | >+1.5 | >+2.0 | >+2.5 | >+3.0 | >+3.5 |
|---|---|---|---|---|---|---|---|---|
| NCEP CFSv2 | 32 | 4.06°C | 100% | 100% | 100% | 100% | 100% | 100% |
| CanESM5 | 20 | 2.65°C | 100% | 100% | 95% | 65% | 20% | 0% |
| GEM5.2-NEMO | 20 | 3.71°C | 100% | 100% | 100% | 100% | 100% | 75% |
| NCAR CCSM4 | 10 | 3.22°C | 100% | 100% | 100% | 100% | 90% | 0% |
| NCAR CESM1 | 10 | 4.28°C | 100% | 100% | 90% | 90% | 90% | 90% |
| **Consensus (equal model wt)** | 5 models | **3.58°C** | 100% | 100% | 97% | 91% | 80% | 53% |

**Consensus read:** The multi-model consensus puts 91% of members above +2.5°C (1997/2015 magnitude), and 80% above +3.0°C, which would exceed every event in the instrumental record (1997 ~2.4, 2015 ~2.6, 1877 ~2.5 on HadISST). These are directly-counted member fractions, not tail extrapolations. As of methodology v1.8 the NMME suite feeds the section-1 headline directly: the multi-model consensus deflection blends these models with ECMWF SEAS5 at weight 0.85. This panel shows the per-model breakdown behind that consensus, including the spread between the hot models (CFSv2, NCAR) and the cooler outliers (CanESM5).

**Panel caveats:**

- NMME updates monthly (around the 8th). This init (2026070800) predates the late-May model runs discussed publicly; the next init will capture those.
...
**Methodology version bumped: 1.8 -> 1.9.** Check the methodology change log for whether headline-bucket comparability to last issue is affected; math changes break comparability, chart or prose changes do not.

**RONI->trad ONI offset changed: +0.6°C -> +0.7°C.** This shifts headline buckets even without underlying probability changes; flag in editorial.

**New agency releases since last issue:**

- **cpc_strength**: prior issued 2026-06-11, now issued 2026-07-09.
    - NDJ 0.5to1.0: 2% -> 0% (Delta -2)
    - NDJ 1.0to1.5: 10% -> 5% (Delta -5)
    - NDJ 1.5to2.0: 25% -> 20% (Delta -5)
    - NDJ >=2.0: 63% -> 75% (Delta +12)

**Unchanged since last issue:** iri, ecmwf, bom.

**Physical state deltas:**

- nino34_weekly_traditional: 1.8 -> 2.0 (delta +0.2)
- nino34_weekly_roni: 1.2 -> 1.3 (delta +0.1)
- cwwa_ms_days: 319.01 -> 359.9 (delta +40.89)
- wwb_events_since_mar1: 8 -> 9 (delta +1)

**New WWB events since last issue (spatial-peak detection):**
...
- **cpc_strength**: fetched live, issued 2026-07-09.
- **oisst_weekly**: fetched live, issued 2026-07-08.
- **heat_content**: fetched live, issued 2026-06-30.
- **iri**: live fetch failed; using last-good cache (issued 2026-05-19). Error: 3-category prose not parseable; IRI may have changed page format again..
- **bom**: fetched live, issued 2026-06-30.
- **ecmwf_seas5**: fetched live, issued 2026-07-01.
- **era5_wwe**: fetched live, issued 2026-07-07.
- **era5_burst**: fetched live, issued 2026-07-08.
- **oni_history**: fetched live, issued 2026-06-30.
- **nmme**: fetched live, issued 2026-07-08.

---

*Generated by run_brief.py from sources.py + probs.py + analog.py. Methodology version 1.9. RONI offset +0.70°C (live, week of 2026-07-08). Next issue: Mon 4 May 2026 (per Monday cadence; first batch run is off-schedule).*
