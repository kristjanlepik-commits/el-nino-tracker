...
def main() -> int:
    ...
    cross_desk = [
        ...
        },
        {
            ...
            "reproduced_by": "heat, 2026-08-31",
            "why_it_matters":
                "The ENSO signal in this region is much stronger in RAINFALL "
                "than in soil moisture, +0.48 against +0.28. Copy saying "
                "'El Nino wets the Pampas' should rest on the rain series; "
                "the soil series will not carry the same claim as firmly, "
                "and the two are easy to conflate because the payload "
                "reports both as percentiles side by side.",
        },
    ]
