    ...
    payload = {
        ...
        "selection": {
            ...
            "how_these_cities_were_chosen":
                "IN STAGES, EACH WITH ITS OWN BIAS, and not one of them "
                "random. The first fifteen were Spanish and French because "
                "the tropical-night metric only works where tropical nights "
                "are common, which is selecting on the very thing being "
                "measured. Germany and Austria were added to reach further "
                "north. Amsterdam was added because it was expected to be "
                "hot. Stockholm was added deliberately to find a city that "
                "was NOT extreme, and is the only member chosen against the "
            ...
            "what_may_be_said":
                ...
                "this set stated as a pattern across this set. The map is 24 "
                "marks and means only what those 24 thermometers recorded.",
            "known_absences":
            ...
            "which_way_the_bias_runs":
                "TOWARD HEAT. A representative sample of European cities "
                "would almost certainly show a smaller share at a record, "
                "because the cities most likely to be extreme were the ones "
                "with a working metric and available data.",
        },
        "coverage_note":
