...
def main() -> int:
    ...
    cross_desk = [
        ...
        {
            "value": "Pampas rainfall percentile against ENSO, r = +0.48, "
                     "n = 34",
            "from_desk": "ENSO tracker",
            "used_for": "not yet used in any published heat copy",
            "reproduced": True,
            "reproduced_against":
                "data/latam_conditions.json against data/oni_full_history.csv, "
                "by ENSO tracker's own published method: pair each season's "
                "rain_pctl with the NDJ ONI of the year the season OPENS. "
                "n = 34, r = +0.48, matching exactly.",
            "reproduced_by": "heat, 2026-08-31",
            "label_retired":
                "This carried label_if_published until the method arrived. "
                "Retired rather than left standing, on ENSO tracker's "
                "reasoning: a label that could be retired and is not becomes "
                "noise, and then it means nothing when it appears on "
                "something that genuinely cannot be checked.",
            "the_judgement_call_in_it":
                "THE SEASON LABEL IS THE YEAR THE SEASON OPENS. '2025-26' is "
                "Sep 2025 to Feb 2026 and pairs with NDJ 2025. ENSO tracker "
                "flagged this as the one judgement in the method and it is "
                "load-bearing: pairing forward instead gives r = -0.03, "
                "n = 33, which is no relationship at all. Verified both ways "
                "rather than taking the pairing on trust.",
        },
        {
            "value": "Pampas SOIL MOISTURE percentile against ENSO, "
                     "r = +0.28, n = 34",
            "from_desk": "heat's own, derived while reproducing the above",
            "used_for": "not yet used; recorded so it is not rediscovered",
            "reproduced": True,
            "reproduced_against": "same two files, same method, soil_pctl "
                                  "in place of rain_pctl",
            "reproduced_by": "heat, 2026-08-31",
            "why_it_matters":
                "For THE PAMPAS the ENSO signal is much stronger in RAINFALL "
                "than in soil moisture, +0.48 against +0.28, so copy saying "
                "'El Nino wets the Pampas' should rest on the rain series. "
                "The two are easy to conflate because the payload reports "
                "both as percentiles side by side.",
            "do_not_generalise_this":
                "THE PAMPAS IS THE EXCEPTION, NOT THE RULE, and reading the "
                "line above as guidance would steer copy away from the "
                "better instrument almost everywhere else. Compared on "
                "MAGNITUDE, because four of these regions are dry-signal "
                "and a more negative r is a stronger signal there, soil "
                "carries the ENSO signal better in five of eight regions, "
                "and the strongest correlation in the whole table is "
                "Roraima SOIL at -0.74, stronger than any rainfall figure "
                "anywhere. Reproduced by heat 2026-08-31 from ENSO "
                "tracker's table:",
            "rain_vs_soil_by_region":
                "Pampas +0.48/+0.28 RAIN; Rio Grande +0.60/+0.70 soil; "
                "Roraima -0.63/-0.74 soil; Venezuela -0.33/-0.56 soil; "
                "Coastal Ecuador -0.03/-0.04 similar; Nordeste "
                "+0.16/+0.12 similar; S Amazon arc -0.01/+0.26 soil; "
                "Altiplano -0.14/-0.30 soil. (rain/soil, NDJ ONI, n = 34.)",
            "how_this_was_nearly_wrong":
                "ENSO tracker's first pass compared SIGNED values rather "
                "than magnitudes, so a dry region whose soil signal is "
                "stronger read as weaker: Venezuela is rain -0.33 against "
                "soil -0.56, soil plainly better, and the flag said the "
                "opposite. The arithmetic was right and the COMPARISON was "
