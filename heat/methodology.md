...
The heat channel tracks two things in forty-one European cities:
...
to the continent. Eighteen of the forty-one are Iberia and France, there is
...
So every count is a count of these cities. "Twenty-two of forty-one" is
...
24 of the 41 cities average too few tropical nights for the measure to
carry a ratio: Aberdeen, Amsterdam, Basel, Belfast, Berlin, Bilbao, Cologne, Dresden, Frankfurt, Geneva, Hamburg, Hanover, Helsinki, Leipzig, London, Munich, Nottingham, Paris, Prague, Stockholm, Strasbourg, Stuttgart, Tallinn, Zurich. Stockholm recorded none at all in 2026 and Amsterdam
